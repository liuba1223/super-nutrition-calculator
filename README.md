...
一个面向食物、食材和餐品配方的营养分析插件。它整合薄荷健康、USDA FoodData Central、中国食物营养数据和本地扩展数据库，支持单个食物查询、餐品营养汇总、30+ 项营养素 DRI 对比，以及将结果插入 Obsidian 笔记。
